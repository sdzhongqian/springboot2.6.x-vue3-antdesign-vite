  ...
  <page-header-wrapper>
        <a-card :bordered="false">
              ...
              <a-row :gutter="48" :style="{width:'100%'}">
                ...
                <a-col :md="6" :sm="24">
                  <a-form-item label="标题">
                    <a-input v-model:value="queryParam.title" placeholder="标题" />
                  </a-form-item>
                </a-col>
                <a-col :md="6" :sm="24">
          ...
          <div class="table-operator">
            <a-button type="primary" @click="handleAdd" v-action:authen:add
              ><plus-outlined />新建</a-button
            >
            <a-dropdown v-if="rowSelection.selectedRowKeys.length > 0" v-action:authen:del>
              <template #overlay>
            ...
            <template #bodyCell="{ column, text, record }">
              <span v-if="column.dataIndex === 'operation'">
                ...
                <a-button
                  size="small"
                  type="primary"
                  v-action-dauth:[{...record,auth:`authen:edit`}]
                ...
                <a-button
                  size="small"
                  type="danger"
                  v-action-dauth:[{...record,auth:`authen:del`}]
...
import { getListPage, delData, updateStatus ,saveOrUpdate } from "@/api/common/authen";
