  ...
  >
    <a-spin :spinning="loading">
      <a-form v-bind="formLayout">
        ...
        <a-form-item v-bind="validateInfos.name" label="组织名称">
          <a-input v-model:value="formRef.name" placeholder="组织名称" />
        </a-form-item>
        <a-form-item v-bind="validateInfos.short_name" label="组织简称">
          <a-input v-model:value="formRef.short_name" placeholder="组织简称" />
        </a-form-item>
  ...
  setup(props) {
    ...
    onMounted(() => {
      if (model != null && model != undefined) {
        ...
        formRef.organize_cascade = model?.organize_cascade;
    ...
    const rulesRef = reactive({
      id: [{ required: false }],
      name: [
        { required: true, max: 50, message: "请输入组织名称且不多余50个字符" },
      ],
      ...
      organize_cascade: [{ required: false }],
